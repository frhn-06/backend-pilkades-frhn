...
router.get("/export/result/pdf", [authMiddleware, electionMiddleware, aclMiddleware([UserRole.SUPER_ADMIN]), electionStatusMiddleware([ElectionStatus.FINISHED])], exportController.resultPDF);
